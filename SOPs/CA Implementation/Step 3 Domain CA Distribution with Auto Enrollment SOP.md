...
\- \*\*Open\*\* the \*\*Root\*\* \*\*.cer\*\* file that is located in the Intermediate CA server's \\\\\\\\\*\*inetpub\\\\wwwroot\\\\CertEnroll\*\* folder (may be done with secure media or network share)
